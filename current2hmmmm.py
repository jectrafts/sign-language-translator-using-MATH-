    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks and pose_results.pose_landmarks:
            ...
            if hi_true(p):
                print(r)
                r+=1
                if (r < 20)and (xs-x_r[9] > hi_deviation or xs-x_r[9] < -hi_deviation) :
            ...
            print("Left Hand:", x_l[6], y_l[6])
            print("Right Hand:", x_r[8], y_r[8])

            print("bob", (y_l[5]-y_l[6]))
