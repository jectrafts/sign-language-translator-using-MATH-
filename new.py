...
def a_true(x_r, y_r):
    if (y_r[7]>y_r[6] and y_r[11]>y_r[10] and y_r[15]>y_r[14] and y_r[19]>y_r[18]) and (y_r[8]>y_r[7] and y_r[12]>y_r[11] and y_r[16]>y_r[15] and y_r[20]>y_r[19])and x_r[5]>x_r[4] and x_r[3]>x_r[4]:
        return 1
